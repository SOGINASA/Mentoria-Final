...
export default function PlatformOperationsPage() {
  ...
  function openAction(alert) {
    const params = new URLSearchParams({ store_id: String(alert.store_id) });
    if (alert.kind === 'timecards') params.set('type', 'timecards');
    navigate(`${alert.action_url}?${params.toString()}`);
  }
