...
const PATHS = {
  ...
  mic: 'M12 4a2.5 2.5 0 0 0-2.5 2.5v5a2.5 2.5 0 0 0 5 0v-5A2.5 2.5 0 0 0 12 4ZM6 11a6 6 0 0 0 12 0M12 17v4M8.5 21h7',
  stop: 'M8 8h8v8H8z',
  calendar: 'M6 3v3M18 3v3M4 8h16M5 5h14a1 1 0 0 1 1 1v14a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1V6a1 1 0 0 1 1-1ZM8 12h3M13 12h3M8 16h3M13 16h3',
  clock: 'M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18ZM12 7v5l3.5 2',
  wallet: 'M4 6h14a2 2 0 0 1 2 2v11H5a2 2 0 0 1-2-2V6.5A2.5 2.5 0 0 1 5.5 4H17M15 12h6v4h-6a2 2 0 0 1 0-4Z',
  clipboard: 'M9 5h6M9 3h6v4H9V3ZM7 5H5v16h14V5h-2M8 12h8M8 16h5',
  book: 'M4 5.5A2.5 2.5 0 0 1 6.5 3H11a2 2 0 0 1 2 2v16a2 2 0 0 0-2-2H6.5A2.5 2.5 0 0 0 4 21.5v-16ZM20 5.5A2.5 2.5 0 0 0 17.5 3H13v18a2 2 0 0 1 2-2h2.5a2.5 2.5 0 0 1 2.5 2.5v-16Z',
  briefcase: 'M9 6V4h6v2M4 7h16a1 1 0 0 1 1 1v11H3V8a1 1 0 0 1 1-1ZM3 12h18M10 12v2h4v-2',
  helpCircle: 'M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18ZM9.7 9a2.5 2.5 0 1 1 3.1 2.4c-.8.3-.8.9-.8 1.6M12 17h.01',
  grid: 'M4 4h6v6H4V4ZM14 4h6v6h-6V4ZM4 14h6v6H4v-6ZM14 14h6v6h-6v-6Z',
  arrowSwap: 'M7 7h12M16 4l3 3-3 3M17 17H5M8 14l-3 3 3 3',
  coffee: 'M5 8h11v6a5 5 0 0 1-5 5h-1a5 5 0 0 1-5-5V8ZM16 10h2a2 2 0 0 1 0 4h-2M8 3v2M12 3v2',
  play: 'M8 5v14l11-7L8 5Z',
  alertTriangle: 'M12 3 2.5 20h19L12 3ZM12 9v5M12 17h.01',
  checkCircle: 'M21 11.2V12a9 9 0 1 1-5.3-8.2M21 4l-9 9-3-3',
  pieChart: 'M12 3v9h9A9 9 0 0 0 12 3ZM9 5a8 8 0 1 0 10 10H9V5Z',
  fileText: 'M6 3h8l4 4v14H6V3ZM14 3v5h4M9 12h6M9 16h6',
  download: 'M12 4v11M8 11l4 4 4-4M5 20h14',
  mail: 'M4 6h16v12H4V6ZM4 7l8 7 8-7',
  phone: 'M7 3h3l1.5 4-2 1.5a15 15 0 0 0 6 6l1.5-2 4 1.5v3c0 2-1.5 4-3.5 4C10 20 4 14 4 6.5 4 4.5 5 3 7 3Z',
  send: 'M3 11.5 21 4l-6.5 16-3.5-6-8-2.5ZM11 14 21 4',
  info: 'M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18ZM12 11v6M12 7h.01',
  downloadCloud: 'M8 18H6a4 4 0 0 1-.5-8A6.5 6.5 0 0 1 18 8.5a4.5 4.5 0 0 1 0 9.5h-2M12 11v10M8.5 17.5 12 21l3.5-3.5',
  more: 'M5 12h.01M12 12h.01M19 12h.01',
  refresh: 'M20 7v5h-5M4 17v-5h5M18.5 9A7 7 0 0 0 6 7l-2 5M5.5 15A7 7 0 0 0 18 17l2-5',
};
