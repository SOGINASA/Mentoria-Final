...
ROLE_PERMISSIONS = {
    ...
    ROLE_MANAGER: {'platform.use', 'shifts.read_own', 'shifts.manage', 'shift_requests.review', 'time.track_own',
    ...
    ROLE_REVIEWER: {'platform.use', 'shifts.read_own', 'shift_requests.review', 'time.track_own', 'time.read_own',
    ...
    ROLE_FINANCE: {'platform.use', 'finance.workspace', 'time.read_all', 'income.read',
                   ...
                   'employee_services.use'},
    ROLE_OPERATIONS: {'platform.use', 'operations.workspace', 'shifts.manage', 'shift_requests.review',
                      'time.manage', 'tasks.manage',
